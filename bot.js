...
var prefix = "$"
var adminprefix = "&"
const developer = ["507962621442392074","id"]
...
client.on("guildMemberAdd", member => {
  client.channels.find('id', '569266514402869259').send(` **Welcome To .. Server! :heart::hugging:  『Ｏ Ｔ』™  ＯＴＡＫＵ     ＴＥＡＭ :**  `)
});
/////////
...
/////
client.login('NTUwNDIwODAyNjM0NTE0NDM1.XWetsw.pmrd8YE1mYWiRNVWBrJuuntS5dw');
